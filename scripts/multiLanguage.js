...
function lang_part(part) {
    ...
    if (part == 'LIVE') {
      ...
      return str;
        ...
        if( ( INFO_USE_VIDEO_ENCODER == true ) && ( INFO_MODEL.indexOf('UTM5HG') >= 0 ) && ( INFO_VENDOR=='I3DVR' ) ){
          ...
          str += '$span&lang_fac_message='+           langArray['LTXT_SETUPSYSMANAGE_SOFT_FAC_MESSAGE'];
        }else{
        ...
        str += '$span&lang_hard_fac_message='+           langArray['LTXT_SETUPSYSMANAGE_FAC_MESSAGE'];
