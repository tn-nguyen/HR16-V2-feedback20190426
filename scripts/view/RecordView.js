...
$z.v({
    ...
    RecCont : {
        ...
        update: function(array) {
            ...
            for( var ch = 0; ch < INFO_DVRCHANNEL ; ch++) {
                var tempSize = array['size7'].substr(ch, 1);
                var tempFps = array['fps7'].substr(ch, 1);
                var tempQul = array['quality7'].substr(ch, 1);
                var tempAudio = array['audio7'].substr(ch, 1);
                
                $("#paramsize"+ch).val(tempSize);
                $("#paramFps"+ch).val(tempFps);
                $("#paramQ"+ch).val(tempQul);
                $("#paramAudio"+ch).val(tempAudio);
            }
        },
